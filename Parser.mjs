      ...
      if (kind === "type") {
        ...
        if (tokens instanceof Stack.Cons.class) {
          ...
          if (param06 instanceof Token.Identifier.class) {
            ...
            name1 = param07;
            if (param15 === false) {
              scrut5 = runtime.safeCall(Keywords.all.get(name1));
      ...
      lambda2 = (undefined, function () {
        ...
        if (tokens instanceof Stack.Cons.class) {
          ...
          if (param02 instanceof Token.Identifier.class) {
            ...
            scrut7 = runtime.safeCall(Keywords.all.get(name));
      ...
      lambda2 = (undefined, function () {
        ...
        if (tokens instanceof Stack.Cons.class) {
          ...
          if (param01 instanceof Token.Identifier.class) {
            ...
            name = param03;
            symbolic = param13;
            scrut1 = runtime.safeCall(Keywords.all.get(name));
            if (scrut1 instanceof Option.Some.class) {
    ...
    exprCont = function exprCont(acc, prec, options) {
      ...
      if (tokens instanceof Stack.Cons.class) {
        ...
        if (param01 instanceof Token.Identifier.class) {
          ...
          param13 = param01.symbolic;
          name1 = param04;
          scrut7 = runtime.safeCall(Keywords.all.get(name1));
          if (scrut7 instanceof Option.Some.class) {
                ...
                if (scrut10 instanceof Option.Some.class) {
                  ...
                  if (param08 instanceof ParseRule.Choice.Ref.class) {
                    ...
                    if (scrut11 === true) {
                      ...
                      name = param04;
                      if (param13 === true) {
                        scrut3 = runtime.safeCall(Keywords.all.get(name));
                        if (scrut3 instanceof Option.None.class) {
                          ...
                          if (scrut4 === true) {
                            ...
                            scrut5 = Keywords.opPrecOpt(name);
      ...
      if (tokens instanceof Stack.Cons.class) {
        ...
        if (param01 instanceof Token.Identifier.class) {
          ...
          if (param02 === ";;") {
            ...
            name = param02;
            scrut = runtime.safeCall(Keywords.all.get(name));
            if (scrut instanceof Option.Some.class) {
              param03 = scrut.value;
              keyword = param03;
